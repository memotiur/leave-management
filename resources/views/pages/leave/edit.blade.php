...
@section('content')
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <form class="form-horizontal" method="post" action="/leave/store"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <input type="text" placeholder="Duration" class="form-control"
                                   name="applicant_leave_duration" id="days" required>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group" style="display: none" id="leave_type2">
                        <label class="col-lg-3 control-label">Write Here</label>
                        <div class="col-lg-9">
                            <input type="text" placeholder="Leave Reason" class="form-control"
                                      name="applicant_leave_type2" input/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <input placeholder="Last Enjoyed Leave  from" class="form-control datepicker"
                                   ...
                                   value="@if(count($last_leave)>0){{$last_leave->applicant_taken_leave_from}}  @endif"
                                   @if(count($last_leave)<=0)id="applicant_taken_leave_from" @endif>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <input placeholder="Last Enjoyed Leave  To" class="form-control datepicker"
                                   ...
                                   value="@if(count($last_leave)>0){{$last_leave->applicant_taken_leave_to}}  @endif"
                                   @if(count($last_leave)<=0)id="applicant_taken_leave_to" @endif>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <input type="text" placeholder="Last Enjoyed Leave  Duration" class="form-control"
                                   name="applicant_taken_leave_duration"
                                   value="@if(count($last_leave)>0){{$last_leave->applicant_leave_duration}}@endif">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <input type="text" placeholder="Leave Time Address " class="form-control"
                                   name="applicant_leave_time_location" required>
                        </div>
                    </div>
    ...
    <script>
        function jsfunc1() {
            ...
            if (document.getElementById('leave_type').value == "Other") {
                document.getElementById("leave_type2").style.display = 'block';
                document.getElementById("leave_typ2").style.display = 'none';
            } else {
                document.getElementById("leave_type").style.display = 'block';
                document.getElementById("leave_type2").style.display = 'none';
            }
        }
